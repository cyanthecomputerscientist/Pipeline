		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo SAPUI5-App",
									"targetURL": "#sapui5demoapp01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5demoapp01-display": {
								"semanticObject": "sapui5demoapp01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5demoapp01",
									"url": sap.ui.require.toUrl("sapui5demoapp01")
								}
							}
						}
					}
